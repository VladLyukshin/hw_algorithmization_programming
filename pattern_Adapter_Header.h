...
public:
	...
	void getParams(double& vol, double& mol, double& mas) // äîáàâèë ñâîé ìåòîä, òàê êàê äëÿ îïåðàöèè èçìåíåíèÿ ìàññû êàêèì-òî îáðàçîì íàäî îáðàòèòüñÿ ê privat mass_
	{
		vol = volume_;
		mol = molar_;
		mas = mass_;
